...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen flex bg-background">
      {/* Sidebar */}
      <aside className="w-60 bg-primary text-primary-foreground p-6 flex flex-col space-y-6">
        <h1 className="text-2xl font-bold mb-8">Campus Life Hub</h1>
        <nav className="flex flex-col space-y-4">
          <Link to="/admin" className="hover:bg-primary-light px-4 py-2 rounded-lg transition-smooth">
            Admin
          </Link>
          <Link to="/dashboard" className="hover:bg-primary-light px-4 py-2 rounded-lg transition-smooth">
            Dashboard
          </Link>
        </nav>
      </aside>
